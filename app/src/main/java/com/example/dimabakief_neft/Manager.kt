...
class Manager {
    ...
    private val workers = listOf(
        Workers(6, "Кочеткова Татьяна Борисовна",
    ...
    fun findDirectionByCode(code: String): Direction? = directions.find { it.code == code }
    ...
    fun findWorkersByPost(teachingSubjects: String): Workers? = workers.find { it.teachingSubjects == teachingSubjects }
    ...
    fun findTeacherByTeachingSubjects(teachingSubjects: String): Workers? = teachers.find { it.teachingSubjects == teachingSubjects }
